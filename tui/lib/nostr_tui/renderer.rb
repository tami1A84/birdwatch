...
module NostrTui
  ...
  class Renderer
    ...
    HINTS = [
      "h/l tabs · j/k move · g/G ends · L like · b upload · n post · N edit · r reply · y yank · o open · q quit",
      "h/l tabs · j/k move · g/G ends · o profile · q quit",
      "R/I/W/O/D/S switch · a add · x remove · A advertise · h/l tabs · q quit",
      "F/E/P blossom · e profile · o QR · s logout · u unlock · i import · h/l tabs · q quit"
    ].freeze
